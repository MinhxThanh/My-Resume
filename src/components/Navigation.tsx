...
const Navigation: React.FC = () => {
  ...
  const handleScroll = useCallback(() => {
    ...
    // Reduced threshold from 40 to 20 for better responsiveness
  ...
  useEffect(() => {
    ...
    const throttledHandleScroll = throttle(handleScroll, 10); // Reduced from 16 to 10 for better responsiveness
    ...
    // Also check after a short delay to catch any initial state
    ...
    <AnimatePresence>
      {isScrolled && (
        <motion.nav
          ...
          className="fixed top-0 left-0 right-0 z-[100] bg-black/90 backdrop-blur-md shadow-lg border-b border-neutral-800"
          style={{ 
            ...
            <div className="flex justify-center items-center py-4 relative">
              ...
              <div className="md:hidden absolute left-0 flex items-center">
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="w-8 h-8 rounded-full bg-gradient-to-r from-accent via-secondary to-accent p-0.5">
                    <img
